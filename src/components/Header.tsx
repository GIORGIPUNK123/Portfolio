...
export const Header = () => {
  ...
  return (
    <>
      <div
        className={`transition duration-200 shadow-2xl ease-in-out fixed top-0 right-0 left-0 z-10 w-full h-12 bg-black  ${
          isHovered ? 'opacity-95' : 'opacity-50'
        }`}
      />
      <div
        className='flex fixed top-0 left-0 z-20 justify-between px-8 w-full h-12'
